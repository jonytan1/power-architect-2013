...
/**
 * Comparator to be sorted by sequence.
 * @author jianjun.tan
 *
 */
public class SequenceSortComparator<E extends SQLObject> implements SQLObjectSortComparator<E>, Serializable {
	...
	public boolean isComparator(SQLObjectSortComparator.Type type) {
		return type==SQLObjectSortComparator.Type.BySequence;
	}
}