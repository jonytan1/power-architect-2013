...
public class OLAPEditAction extends AbstractArchitectAction {
    ...
    public OLAPEditAction(ArchitectSwingSession session, OLAPSession olapSession) {
        super(session, 
                olapSession == null
                        ? Messages.getString("OLAP.NewSchemaActionName")
                        : olapSession.getSchema().getName(),
                olapSession == null
                        ? Messages.getString("OLAP.NewSchemaDescription")
                        : Messages.getString("OLAP.EditSchemaDescription"));
