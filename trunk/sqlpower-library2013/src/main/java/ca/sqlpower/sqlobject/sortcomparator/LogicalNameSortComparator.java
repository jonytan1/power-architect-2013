...
/**
 * Comparator to be sorted by logical name of SQLObject.
 * @author jianjun.tan
 *
 */
public class LogicalNameSortComparator<E extends SQLObject> implements SQLObjectSortComparator<E>, Serializable {
	...
	public LogicalNameSortComparator() {}
	...
	public boolean isComparator(SQLObjectSortComparator.Type type) {
		return type==SQLObjectSortComparator.Type.ByLogicalName;
	}
}