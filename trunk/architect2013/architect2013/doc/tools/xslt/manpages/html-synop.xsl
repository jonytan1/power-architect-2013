...
<!-- ********************************************************************
     $Id: html-synop.xsl 903 2006-06-21 22:32:15Z johnson $
     ********************************************************************
  ...
  <tr>
    <xsl:choose>
      ...
      <xsl:otherwise>
        <td>
	  <code>
	    <xsl:apply-templates select="parameter/preceding-sibling::*[not(self::parameter)]" mode="kr-tabular-funcsynopsis-mode"/>
	  </code>
          <xsl:text> </xsl:text>
        </td>
        <td>
...
<xsl:template match="paramdef" mode="ansi-tabular">
  <xsl:choose>
    ...
    <xsl:otherwise>
      <td>
        <xsl:apply-templates select="parameter/preceding-sibling::*[not(self::parameter)]" mode="ansi-tabular"/>
        <xsl:text> </xsl:text>
      </td>
      <td>
